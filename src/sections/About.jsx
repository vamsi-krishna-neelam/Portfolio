      ...
      <div className="flex flex-col-reverse lg:flex-row-reverse">
        ...
        <div className="lg:w-1/2 py-8 md:py-12 px-4 md:px-12 text-white">
          ...
          <p className="work-sans-regular text-base md:text-xl mt-4">
            Pursuing B.Tech in Electronics and Communication Engineering (ECE) at Tezpur University, Assam. Skilled in frontend and backend development, proficient in translating complex requirements into elegant solutions, and driven by a passion for continuous learning and innovation. Solved 180+ DSA questions on LeetCode, 4-star rating on HackerRank in DSA.
          </p>
